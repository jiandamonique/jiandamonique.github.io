...
This portfolio is built with core HTML/CSS/JS, featuring a custom Ghibli-inspired design token system, ambient watercolor gradients, and responsive CSS grid layouts. The content flows through the following sections:

### 1. About // Metaphysical, Multimedia, Data-Diver
A look into my journey as a Full Stack Developer in training, transformative coder, holistic coach, writer, and musician. 
* **Background:** Experience spanning MP3.com, Amazon, and the UCSF Epidemiology Team.
* **Fellowship:** Details my time as a 2021 Kaggle/Google BIPOC Data Fellow under mentors Prasun Kumar Mishra and Julia Elliott.
* **Education:** UC Irvine, Pomona College, UMass Dartmouth, and CSSSA at CalArts.
* **Creative Practice:** Published author, vocalist (Tycho "Dive", Om Lounge 10), busker, and SF Public Library Fellow.
...
The mutual aid project and my other initiatives are unfunded and independent. If you believe in building resources for BIPOC and LGBTQ+ artists, or simply appreciate the work, any contribution helps keep the servers running and the code flowing. 

* [Venmo](https://venmo.com/jayevajohnson)
* [PayPal](https://www.paypal.com/paypalme/jmcommunity)
* [GoFundMe](http://www.gofundme.com/f/help-me-develop-artist-mutual-aid-site)
* [GitHub Sponsors](https://github.com/sponsors)

---
*"Art heals. Code connects. Each one, reach one."*
